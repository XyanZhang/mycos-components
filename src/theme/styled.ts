...
export const StyledInput = styled.input<{
  ...
  border-radius: 4px;
  border: 1px solid
    ${(props) => (props.error ? props.theme.colors.error.main : props.theme.colors.border.main)};
  background-color: ${(props) =>
    props.disabled ? props.theme.colors.background.paper : props.theme.colors.background.default};
  color: ${(props) =>
